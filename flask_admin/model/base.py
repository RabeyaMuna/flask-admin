...
class BaseModelView(BaseView, ActionsMixin):
    ...
    column_formatters: T_COLUMN_FORMATTERS = cast(  # type: ignore[type-arg]
        T_COLUMN_FORMATTERS,  # type: ignore[type-arg]
    ...
    column_formatters_export: T_COLUMN_FORMATTERS | None = None  # type: ignore[type-arg]
    """
    ...
    column_formatters_detail: T_COLUMN_FORMATTERS | None = None  # type: ignore[type-arg]
    """
    ...
    def _get_list_value(
        ...
        model: T_ORM_MODEL,
        name: str,
        column_formatters: T_COLUMN_FORMATTERS,  # type: ignore[type-arg]
